      ...
      <div className="navbar1">
        <div className="navbar bg-base-100">
          <div className="navbar-start">
            <div className="dropdown">
              <div tabIndex={0} role="button">
                <h2 className='ml-6 text-2xl cursor-pointer'>DashWind</h2>
              </div>
          ...
          <div className="navbar-center">
            <a className="btn btn-ghost text-xl">Integrations</a>
          </div>
        ...
        <div className="card1">
          <div className="card w-96 bg-base-100 shadow-xl">
            <div className="card-body">
              ...
              <div className="texts">
                <img width={70} src={slack} alt="" />
                <p>
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolor debitis tenetur quos!
                </p>
              </div>
              <input style={{marginLeft:"280px",marginTop:"20px"}} type="checkbox" value="synthwave" className="toggle theme-controller"/>
            </div>
          </div>
        </div>
        <div className="card1">
